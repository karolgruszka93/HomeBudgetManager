...
public class ConstantExpensesTabControllerTest 
{
	ConstantExpensesTabController test =  new ConstantExpensesTabController();
	...
	{
		assertSame(ce, test.prepareDataToChart(budgetList, chosenYear).get(0));
	}
