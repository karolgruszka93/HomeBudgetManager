...
public class SavingsTabControllerTest 
{
	SavingsTabController test =  new SavingsTabController();
	...
	{
		assertSame(sv, test.prepareDataToChart(budgetList, chosenYear).get(0));
	}
}
